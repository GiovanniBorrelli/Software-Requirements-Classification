...
word2vec_model = Word2Vec(sentences, min_count=1, workers=4)

# Estrai le features usando il word embedding di Word2Vec
X_features = np.array([np.mean([word2vec_model.wv[word] for word in sentence if word in word2vec_model.wv]
